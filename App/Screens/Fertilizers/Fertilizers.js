...
//         token: state.authReducer["token"],
//         fertilizers: state.appRecuder["fertilizers"],
//         fertilizerSubRes: state.appRecuder["fertilizerSubRes"]
...
// const mapDispatchToProps = dispatch => {
//     return {
//         getFertilizer: (token) => dispatch(AppActions.getFertilizer(token)),
//         submitFertilizerResponse: (obj, token) => dispatch(AppActions.submitFertilizerResponse(obj, token)),
//         clearFertilizerSubmitResponse: () => dispatch(AppActions.clearFertilizerSubmitResponse())
...
//     constructor(props) {
//         super(props);
//         this.state = { showModal: false, _id: "", name: "", email: "", quantity: "", price: "" }

//     }
//     componentDidMount() {
//         this.props.getFertilizer(this.props.token)
//     }
//     static getDerivedStateFromProps(props, state) {
//         if (props.fertilizerSubRes && state.showModal && props.navigation.isFocused()) {
//             props.clearFertilizerSubmitResponse();
//             return {
//                 showModal: false
//             }
//         }
...
//     }
//     showForm = (index) => {
//         // console.log(this.props.fertilizers);
//         let { _id } = this.props.fertilizers[index];
...
//         this.props.submitFertilizerResponse(obj, this.props.token);
...
//                     <Text style={{ color: "#000", fontWeight: "bold", fontSize: fontScale * 20 }} >Fertilizers</Text>
//                 </View>
//                 {this.props.isProgress ?
//                     <Spinner />
//                     :
//                     <View style={{ flex: 0.9 }} >
//                         <FlatList data={this.props.fertilizers && this.props.fertilizers} renderItem={({ item, index }) =>
//                             <ListItem>
//                                 <View style={{ flex: 1 }} >
...
//                                             <Text style={{ fontWeight: "bold" }} >Name: </Text><Text>{`${item.name}\n`}</Text>
//                                         </View>
//                                         <View style={{ flex: 0.8 }} >
//                                             <Text style={{ fontWeight: "bold" }} >Description: </Text><Text>{`${item.application}\n`}</Text>
//                                         </View>
//                                         <View style={{ flexDirection: "row", flex: 0.1 }} >
...
//                                 </View>
//                                 <View style={{ flex: 0.2, }} >
//                                     <Input placeholder="Expected Price" onChangeText={(price) => this.setState({ price })} />
//                                 </View>
//                                 <View style={{ flex: 0.2 }} >
